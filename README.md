...
# ご注意！！　XIAO ESP32S3(およびSense）の対応について（2023年5月28日記載）

国内販売開始に合わせて確認しました所、動作自体についてはESP32C3版のソースコードがそのまま使えました。

ただし、基板のパターンについて想定外であった箇所があり、不具合が発生する可能性があります。

今後の製造出荷分についてはモジュール側で対応させて頂きますが、お手持ちのモジュールで急ぎXIAO ESP32S3を使用したい場合は以下の対応をお願いいたします。
